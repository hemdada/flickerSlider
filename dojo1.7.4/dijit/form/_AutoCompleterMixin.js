...
this.dropDown.createOptions(_1b,_1d,_8.hitch(this,"_getMenuLabelFromItem"));
...
var _1f=this.get("displayedValue");
var pw=this.dropDown;
if(pw&&(_1f==pw._messages["previousMessage"]||_1f==pw._messages["nextMessage"])){
this._setValueAttr(this._lastValueReported,true);
}else{
if(typeof this.item=="undefined"){
this.item=null;
this.set("displayedValue",_1f);
}else{
...
},_setItemAttr:function(_20,_21,_22){
var _23="";
if(_20){
if(!_22){
_22=this.store._oldAPI?this.store.getValue(_20,this.searchAttr):_20[this.searchAttr];
}
_23=this._getValueField()!=this.searchAttr?this.store.getIdentity(_20):_22;
}
this.set("value",_23,_21,_22,_20);
},_announceOption:function(_24){
if(!_24){
return;
}
var _25;
if(_24==this.dropDown.nextButton||_24==this.dropDown.previousButton){
_25=_24.innerHTML;
this.item=undefined;
this.value="";
}else{
var _26=this.dropDown.items[_24.getAttribute("item")];
_25=(this.store._oldAPI?this.store.getValue(_26,this.searchAttr):_26[this.searchAttr]).toString();
this.set("item",_26,false,_25);
}
this.focusNode.value=this.focusNode.value.substring(0,this._lastInput.length);
this.focusNode.setAttribute("aria-activedescendant",_5.get(_24,"id"));
