...
var _22=_20?_f.around(_21,_20,_1f,ltr,_1e.orient?_c.hitch(_1e,"orient"):null):_f.at(_21,_1c,_1f=="R"?["TR","BR","TL","BL"]:["TL","BL","TR","BR"],_1c.padding);
_21.style.display="";
_21.style.visibility="visible";
_1e.domNode.style.visibility="visible";
var _23=[];
_23.push(on(_21,_3._keypress,_c.hitch(this,function(evt){
if(evt.charOrCode==_b.ESCAPE&&_1c.onCancel){
_a.stop(evt);
_1c.onCancel();
}else{
...
_23.push(_1e.on(_1e.onExecute?"execute":"change",_c.hitch(this,function(){
